...
import { addInstructorData } from "../../../../../config/data/manageEmployeeData/AddEmployeeData";
      ...
      >
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            try {
              // Getting new instructor information.
              const userInput = {
              ...
              setIsLoading(true);
              // Sending new instructor information to server.
              const response = await createEmployee(userInput);

              if (response.success) {
                toast.success("Instructor added successfully.");

                // Adding id to the row of new instructor and update the instructors' table.
        ...
        >
          {({ handleSubmit }) => (
            <form onSubmit={handleSubmit}>
              ...
              >
                {addInstructorData.map((data, index) => {
